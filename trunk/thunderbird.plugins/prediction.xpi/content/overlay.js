...
//	callGenericWrapper();
	...
	var path = file.path + "/extensions/word-prediction@project.team/content/java/hsql/words";
...
//	path.replace(/\\/g,"/");
	...
	var result1 = mInstance.init(path);//"jdbc:hsqldb:file:C:\Documents and Settings\Administrator\Application Data\Thunderbird\Profiles\pyp3w7hi.default\extensions\javaDemo@brett.zamir\content\java\hsql\words");//path); 
	alert(result1);
}
